...
# Define paths
directory_path = r'C:\Users\1234\OneDrive - 인하대학교\바탕 화면\ESG_Logistics\1.3_Korea_KLN_extracted_articles'
output_dir = r'C:\Users\1234\OneDrive - 인하대학교\바탕 화면\ESG_Logistics'
os.makedirs(output_dir, exist_ok=True)

# Define the markers for extraction
markers = [
    {"start": "* __입력", "end": "* __댓글 0"},
...
excel_file_path = os.path.join(output_dir, '1.4.1_Korea_KLN_News Title & Date.xlsx')
